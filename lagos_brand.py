...
">
    ...
    <div style="display: flex; justify-content: center; align-items: center; gap: 20px; flex-wrap: wrap; font-size: 0.95rem; font-weight: 600;">
        ...
        <div>
            <a href="https://wa.me/2349038819790" target="_blank" style="
                display: inline-flex; align-items: center; gap: 6px;
                background: #25D366; color: #FFFFFF !important;
                font-weight: 700; font-size: 0.88rem; padding: 6px 14px;
            ...
            ">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="white">
                    ...
                    <path d="M12 0C5.373 0 0 5.373 0 12c0 2.124.558 4.117 1.532 5.845L.057 23.882l6.198-1.625A11.934 11.934 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.894a9.875 9.875 0 01-5.027-1.371l-.361-.214-3.681.965.981-3.594-.234-.368A9.865 9.865 0 012.107 12C2.107 6.529 6.529 2.107 12 2.107S21.893 6.529 21.893 12 17.471 21.894 12 21.894z"/>
                </svg>
                Chat on WhatsApp
            </a>
        </div>
